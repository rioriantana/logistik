...
public class MenuActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_pengungsi) {
            Intent intent = new Intent(MenuActivity.this, PengungsiActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_kebutuhan) {
            Intent intent = new Intent(MenuActivity.this, KebutuhanActivity.class);
            startActivity(intent);
